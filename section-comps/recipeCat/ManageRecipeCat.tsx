...
export default function ManageRecipeCategories() {
	const [categories, setCategories] = useState<ICategoryRecipeType[]>([]);
	const [modalVisible, setModalVisible] = useState(false);
	const [selectedCategory, setSelectedCategory] =
		useState<ICategoryRecipeType | null>(null);
	...
	const openCategoryDetails = (category: ICategoryRecipeType) => {
	...
	return (
		<View style={styles.container}>
			<Text style={styles.title}>Manage Recipe Categories</Text>
            {/* button for creating new recipe category */}
